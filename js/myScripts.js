...
//trying to append or replace content of other area ddl
function getOtherArea() {
     var stateOtherddl = $('#ddlOtherState option:selected').html();
     var areaOtherddl = $('#ddlOtherArea');
     var i = 0;

     switch (stateOtherddl) {
          case "Abia":
               areaOtherddl.empty();
               for (i = 0; i < abiaArray.length; i++) {
                    areaOtherddl.append("<option value='" + abiaArray[i] + "'>" + abiaArray[i] + "</option>");
               }
               break;
          case "Adamawa":
               areaOtherddl.empty();
               for (i = 0; i < adamawaArray.length; i++) {
                    areaOtherddl.append("<option value='" + adamawaArray[i] + "'>" + adamawaArray[i] + "</option>");
               }
               break;
          case "Akwa Ibom":
               areaOtherddl.empty();
               for (i = 0; i < akwaIbomArray.length; i++) {
                    areaOtherddl.append("<option value='" + akwaIbomArray[i] + "'>" + akwaIbomArray[i] + "</option>");
               }
               break;
          case "Anambra":
               areaOtherddl.empty();
               for (i = 0; i < anambraArray.length; i++) {
                    areaOtherddl.append("<option value='" + anambraArray[i] + "'>" + anambraArray[i] + "</option>");
               }
               break;
          case "Bauchi":
               areaOtherddl.empty();
               for (i = 0; i < bauchiArray.length; i++) {
                    areaOtherddl.append("<option value='" + bauchiArray[i] + "'>" + bauchiArray[i] + "</option>");
               }
               break;
          case "Bayelsa":
               areaOtherddl.empty();
               for (i = 0; i < bayelsaArray.length; i++) {
                    areaOtherddl.append("<option value='" + bayelsaArray[i] + "'>" + bayelsaArray[i] + "</option>");
               }
               break;
          case "Benue":
               areaOtherddl.empty();
               for (i = 0; i < benueArray.length; i++) {
                    areaOtherddl.append("<option value='" + benueArray[i] + "'>" + benueArray[i] + "</option>");
               }
               break;
          case "Borno":
               areaOtherddl.empty();
               for (i = 0; i < bornoArray.length; i++) {
                    areaOtherddl.append("<option value='" + bornoArray[i] + "'>" + bornoArray[i] + "</option>");
               }
               break;
          case "Cross River":
               areaOtherddl.empty();
               for (i = 0; i < crossRiverArray.length; i++) {
                    areaOtherddl.append("<option value='" + crossRiverArray[i] + "'>" + crossRiverArray[i] + "</option>");
               }
               break;
          case "Delta":
               areaOtherddl.empty();
               for (i = 0; i < deltaArray.length; i++) {
                    areaOtherddl.append("<option value='" + deltaArray[i] + "'>" + deltaArray[i] + "</option>");
               }
               break;
          case "Ebonyi":
               areaOtherddl.empty();
               for (i = 0; i < ebonyiArray.length; i++) {
                    areaOtherddl.append("<option value='" + ebonyiArray[i] + "'>" + ebonyiArray[i] + "</option>");
               }
               break;
          case "Edo":
               areaOtherddl.empty();
               for (i = 0; i < edoArray.length; i++) {
                    areaOtherddl.append("<option value='" + edoArray[i] + "'>" + edoArray[i] + "</option>");
               }
               break;
          case "Ekiti":
               areaOtherddl.empty();
               for (i = 0; i < ekitiArray.length; i++) {
                    areaOtherddl.append("<option value='" + ekitiArray[i] + "'>" + ekitiArray[i] + "</option>");
               }
               break;
          case "Enugu":
               areaOtherddl.empty();
               for (i = 0; i < enuguArray.length; i++) {
                    areaOtherddl.append("<option value='" + enuguArray[i] + "'>" + enuguArray[i] + "</option>");
               }
               break;
          case "Gombe":
               areaOtherddl.empty();
               for (i = 0; i < gombeArray.length; i++) {
                    areaOtherddl.append("<option value='" + gombeArray[i] + "'>" + gombeArray[i] + "</option>");
               }
               break;
          case "Imo":
               areaOtherddl.empty();
               for (i = 0; i < imoArray.length; i++) {
                    areaOtherddl.append("<option value='" + imoArray[i] + "'>" + imoArray[i] + "</option>");
               }
               break;
          case "Jigawa":
               areaOtherddl.empty();
               for (i = 0; i < jigawaArray.length; i++) {
                    areaOtherddl.append("<option value='" + jigawaArray[i] + "'>" + jigawaArray[i] + "</option>");
               }
               break;
          case "Kaduna":
               areaOtherddl.empty();
               for (i = 0; i < kadunaArray.length; i++) {
                    areaOtherddl.append("<option value='" + kadunaArray[i] + "'>" + kadunaArray[i] + "</option>");
               }
               break;
          case "Kano":
               areaOtherddl.empty();
               for (i = 0; i < kanoArray.length; i++) {
                    areaOtherddl.append("<option value='" + kanoArray[i] + "'>" + kanoArray[i] + "</option>");
               }
               break;
          case "Katsina":
               areaOtherddl.empty();
               for (i = 0; i < katsinaArray.length; i++) {
                    areaOtherddl.append("<option value='" + katsinaArray[i] + "'>" + katsinaArray[i] + "</option>");
               }
               break;
          case "Kebbi":
               areaOtherddl.empty();
               for (i = 0; i < kebbiArray.length; i++) {
                    areaOtherddl.append("<option value='" + kebbiArray[i] + "'>" + kebbiArray[i] + "</option>");
               }
               break;
          case "Kogi":
               areaOtherddl.empty();
               for (i = 0; i < kogiArray.length; i++) {
                    areaOtherddl.append("<option value='" + kogiArray[i] + "'>" + kogiArray[i] + "</option>");
               }
               break;
          case "Kwara":
               areaOtherddl.empty();
               for (i = 0; i < kwaraArray.length; i++) {
                    areaOtherddl.append("<option value='" + kwaraArray[i] + "'>" + kwaraArray[i] + "</option>");
               }
               break;
          case "Lagos":
               areaOtherddl.empty();
               for (i = 0; i < lagosArray.length; i++) {
                    areaOtherddl.append("<option value='" + lagosArray[i] + "'>" + lagosArray[i] + "</option>");
               }
               break;
          case "Nasarawa":
               areaOtherddl.empty();
               for (i = 0; i < nasarawaArray.length; i++) {
                    areaOtherddl.append("<option value='" + nasarawaArray[i] + "'>" + nasarawaArray[i] + "</option>");
               }
               break;
          case "Niger":
               areaOtherddl.empty();
               for (i = 0; i < nigerArray.length; i++) {
                    areaOtherddl.append("<option value='" + nigerArray[i] + "'>" + nigerArray[i] + "</option>");
               }
               break;
          case "Ogun":
               areaOtherddl.empty();
               for (i = 0; i < ogunArray.length; i++) {
                    areaOtherddl.append("<option value='" + ogunArray[i] + "'>" + ogunArray[i] + "</option>");
               }
               break;
          case "Ondo":
               areaOtherddl.empty();
               for (i = 0; i < ondoArray.length; i++) {
                    areaOtherddl.append("<option value='" + ondoArray[i] + "'>" + ondoArray[i] + "</option>");
               }
               break;
          case "Osun":
               areaOtherddl.empty();
               for (i = 0; i < osunArray.length; i++) {
                    areaOtherddl.append("<option value='" + osunArray[i] + "'>" + osunArray[i] + "</option>");
               }
               break;
          case "Oyo":
               areaOtherddl.empty();
               for (i = 0; i < oyoArray.length; i++) {
                    areaOtherddl.append("<option value='" + oyoArray[i] + "'>" + oyoArray[i] + "</option>");
               }
               break;
          case "Plateau":
               areaOtherddl.empty();
               for (i = 0; i < plateauArray.length; i++) {
                    areaOtherddl.append("<option value='" + plateauArray[i] + "'>" + plateauArray[i] + "</option>");
               }
               break;
          case "Rivers":
               areaOtherddl.empty();
               for (i = 0; i < riversArray.length; i++) {
                    areaOtherddl.append("<option value='" + riversArray[i] + "'>" + riversArray[i] + "</option>");
               }
               break;
          case "Sokoto":
               areaOtherddl.empty();
               for (i = 0; i < sokotoArray.length; i++) {
                    areaOtherddl.append("<option value='" + sokotoArray[i] + "'>" + sokotoArray[i] + "</option>");
               }
               break;
          case "Taraba":
               areaOtherddl.empty();
               for (i = 0; i < tarabaArray.length; i++) {
                    areaOtherddl.append("<option value='" + tarabaArray[i] + "'>" + tarabaArray[i] + "</option>");
               }
               break;
          case "Yobe":
               areaOtherddl.empty();
               for (i = 0; i < yobeArray.length; i++) {
                    areaOtherddl.append("<option value='" + yobeArray[i] + "'>" + yobeArray[i] + "</option>");
               }
               break;
          case "Zamfara":
               areaOtherddl.empty();
               for (i = 0; i < zamfaraArray.length; i++) {
                    areaOtherddl.append("<option value='" + zamfaraArray[i] + "'>" + zamfaraArray[i] + "</option>");
               }
               break;
          case "F.C.T":
               areaOtherddl.empty();
               for (i = 0; i < fctArray.length; i++) {
                    areaOtherddl.append("<option value='" + fctArray[i] + "'>" + fctArray[i] + "</option>");
               }
               break;
          default:
               areaOtherddl.empty();
               for (i = 0; i < defaultArray.length; i++) {
                    areaOtherddl.append("<option value='" + defaultArray[i] + "'>" + defaultArray[i] + "</option>");
               }
     }
};
